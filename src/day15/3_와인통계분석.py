...
print(t통계량) #-9.685649554187696 #첫 번째 집단의 평균이 두번째 집단보다 낮다는 뜻 # 해석 : 화이트 등급이 평균적으로 9.68 차이가 있다
...
Time:                        12:54:24   Log-Likelihood:                -7623.4
...
-coef : 회귀계수
    0.3253 해석 : 알콜과 와인 등급 관계 해석 # 알콜(독립변수)이 1 단위 증가할때마다 등급이 0.3253 증가한다(알콜이 3증가하면 등급은 대략 1 증가한다.)
-std err : 표준 오차
-t : t검증 통계량
-P>|t| : t검증 p값
    - 0.000 : 0.05보다 작으면 검증의 효과가 있다.
-[0.025       0.975] : 앞뒤 2.5% 버리고 사이에 존재하면 신뢰
